...
class LoginPage:
    def __init__(self, root, width, height):
        ...
        heading = Label(frame2, text='Login', fg="#57a1f8", bg='white', font=('Microsoft Yahei UI Light', 23, 'bold'))
        ...
        username_entry = Entry(frame2, highlightthickness=0, relief=FLAT, bg="white", fg="black",
        ...
        password_entry = Entry(frame2, highlightthickness=0, relief=FLAT, bg="white", fg="black",
                               font=("Microsoft Yahei UI Light", 13, "bold"))
        password_entry.place(x=190, y=340, width=250)
        ...
        Button(frame2, text='i have forget my password', fg='blue', bg='white', border=0,
               font=('Microsoft Yahei UI Light', 9), cursor='hand2',
               command=lambda: Forgetpassword(self.frame, width, height)).place(x=190, y=380)

        Button(frame2, width=30, pady=7, text='Login', bg='#57a1f8', fg='white', cursor='hand2', border=0).place(x=200,
                                                                                                                 y=420)

        from pages.authentication.register import RegisterPage

        Button(frame2, width=30, pady=7, text='Register', bg='#57a1f8', fg='white', cursor='hand2',

...
class LoginPage:
    def __init__(self,root,width,height):
        ...
        password_entry=Entry(frame2,highlightthickness=0,relief=FLAT,bg="white",fg="black",font=("Microsoft Yahei UI Light",13,"bold"))
        ...
        Button(frame2,width=30,pady=7,text='Register',bg='#57a1f8',fg='white',cursor='hand2',command=lambda:RegisterPage(self.frame,width,height),border=0).place(x=200,y=480)

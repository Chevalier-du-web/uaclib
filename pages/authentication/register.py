...
class RegisterPage:
    def __init__(self, root, width, height):
        ...
        gender_entry = Entry(frame2, highlightthickness=0, relief=FLAT, bg="white", fg="black",
                             font=("Microsoft Yahei UI Light", 11))
        ...
        level_entry = Entry(frame2, highlightthickness=0, relief=FLAT, bg="white", fg="black",
                            font=("Microsoft Yahei UI Light", 11))
        ...
        email_entry = Entry(frame2, highlightthickness=0, relief=FLAT, bg="white", fg="black",
                            font=("Microsoft Yahei UI Light", 11))
        ...
        ####button
        Button(frame2, width=30, pady=7, text='Register', bg='#57a1f8', fg='white', cursor='hand2', border=0).place(
            x=200, y=600)

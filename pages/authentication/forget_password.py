...
class Forgetpassword:
    def __init__(self, root, width, height):
        ...
        heading = Label(frame2, text='You have forget your password?? dont worry ...', fg="#57a1f8", bg='white',
        ...
        Button(frame2, width=30, pady=7, text='Submit', bg='#57a1f8', fg='white', cursor='hand2', border=0).place(x=200,
                                                                                                                  y=420)
